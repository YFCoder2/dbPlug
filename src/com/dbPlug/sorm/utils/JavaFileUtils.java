...
import com.dbPlug.sorm.core.MySqlTypeConvertor;
import com.dbPlug.sorm.core.TableContext;
import com.dbPlug.sorm.core.TypeConvertor;
...
public class JavaFileUtils {
	...
	public static void createJavaPOFile(TableInfo tableInfo,TypeConvertor convertor){
		...
		String packagePath = DBManager.getConf().getPoPackage().replaceAll("\\.", "/");File f = new File(srcPath+packagePath);
